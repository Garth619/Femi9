...
<p>Here you will learn more about femi9, our goals, what we value and what it takes to qualify to become our franchisee and strategic partner in growing our brand across new markets.</p> 
	...
	<div class="mobile_models1_wrapper">
		<div class="orange_models1"></div><!-- orange_models1 -->
		<img class="mobile_grid" src="<?php bloginfo('template_directory');?>/images/grid.png"/>
		<img class="mobile_models1" src="<?php bloginfo('template_directory');?>/images/mobile-models1.jpg"/>
